...
from idecutils import cluster_acc,cal_sen_spe,fscore_score,purity_score
import idecutils
import h5py
import csv
...
class IDEC(nn.Module):
    ...
    def __init__(self,
                 ...
                 n_z,
                 n_clusters,
                 pretrain_path='data/ae_WM_nxm.pkl'):
    ...
    def pretrain(self, path=''):
        if args.pretrain_flag == 0:
            ...
            pre_weights = torch.load(self.pretrain_path,map_location=device)
            pre_weights.pop("enc0_1.weight")
            pre_weights.pop("enc0_2.weight")
            pre_weights.pop("enc0_3.weight")
            pre_weights.pop("enc1_1.weight")
            pre_weights.pop("enc1_2.weight")
            pre_weights.pop("enc1_3.weight")
            pre_weights.pop("enc2_1.weight")
            pre_weights.pop("enc2_2.weight")
            pre_weights.pop("enc2_3.weight")
            pre_weights.pop("enc3_1.weight")
            pre_weights.pop("enc3_2.weight")
            pre_weights.pop("enc3_3.weight")
            pre_weights.pop("enc4_1.weight")
            pre_weights.pop("enc4_2.weight")
            pre_weights.pop("enc4_3.weight")
            pre_weights.pop("enc0_1.bias")
            pre_weights.pop("enc0_2.bias")
            pre_weights.pop("enc0_3.bias")
            pre_weights.pop("enc1_1.bias")
            pre_weights.pop("enc1_2.bias")
            pre_weights.pop("enc1_3.bias")
            pre_weights.pop("enc2_1.bias")
            pre_weights.pop("enc2_2.bias")
            pre_weights.pop("enc2_3.bias")
            pre_weights.pop("enc3_1.bias")
            pre_weights.pop("enc3_2.bias")
            pre_weights.pop("enc3_3.bias")
            pre_weights.pop("enc4_1.bias")
            pre_weights.pop("enc4_2.bias")
            pre_weights.pop("enc4_3.bias")
            pre_weights.pop("z0_layer.weight")
            pre_weights.pop("z1_layer.weight")
            pre_weights.pop("z2_layer.weight")
            pre_weights.pop("z3_layer.weight")
            pre_weights.pop("z4_layer.weight")
            pre_weights.pop("z0_layer.bias")
            pre_weights.pop("z1_layer.bias")
            pre_weights.pop("z2_layer.bias")
            pre_weights.pop("z3_layer.bias")
            pre_weights.pop("z4_layer.bias")
            pre_weights.pop("dec0_0.weight")
            pre_weights.pop("dec0_1.weight")
            pre_weights.pop("dec0_2.weight")
            pre_weights.pop("dec0_3.weight")
            pre_weights.pop("dec1_0.weight")
            pre_weights.pop("dec1_1.weight")
            pre_weights.pop("dec1_2.weight")
            pre_weights.pop("dec1_3.weight")
            pre_weights.pop("dec2_0.weight")
            pre_weights.pop("dec2_1.weight")
            pre_weights.pop("dec2_2.weight")
            pre_weights.pop("dec2_3.weight")
            pre_weights.pop("dec3_0.weight")
            pre_weights.pop("dec3_1.weight")
            pre_weights.pop("dec3_2.weight")
            pre_weights.pop("dec3_3.weight")
            pre_weights.pop("dec4_0.weight")
            pre_weights.pop("dec4_1.weight")
            pre_weights.pop("dec4_2.weight")
            pre_weights.pop("dec4_3.weight")
            pre_weights.pop("dec0_0.bias")
            pre_weights.pop("dec0_2.bias")
            pre_weights.pop("dec0_3.bias")
            pre_weights.pop("dec1_0.bias")
            pre_weights.pop("dec1_2.bias")
            pre_weights.pop("dec1_3.bias")
            pre_weights.pop("dec2_0.bias")
            pre_weights.pop("dec2_2.bias")
            pre_weights.pop("dec2_3.bias")
            pre_weights.pop("dec3_0.bias")
            pre_weights.pop("dec3_2.bias")
            pre_weights.pop("dec3_3.bias")
            pre_weights.pop("dec4_0.bias")
            pre_weights.pop("dec4_2.bias")
            pre_weights.pop("dec4_3.bias")
            pre_weights.pop("x0_bar_layer.weight")
            pre_weights.pop("x1_bar_layer.weight")
            pre_weights.pop("x2_bar_layer.weight")
            pre_weights.pop("x3_bar_layer.weight")
            pre_weights.pop("x4_bar_layer.weight")
            pre_weights.pop("x0_bar_layer.bias")
            pre_weights.pop("x1_bar_layer.bias")
            pre_weights.pop("x2_bar_layer.bias")
            pre_weights.pop("x3_bar_layer.bias")
            pre_weights.pop("x4_bar_layer.bias")

            # pre_dict = {k:v for k,v in pre_weights.items() if "classifer" not in k}
            self.ae.load_state_dict(pre_weights,strict=False)
...
#    model.train()
    ...
    for epoch in range(int(args.maxiter)):
        ...
        senspe = cal_sen_spe(y, y_pred)
        pur = purity_score(y, y_pred)
        f1score = fscore_score(y, y_pred)
        Bacc = (senspe[1] + senspe[0]) / 2
        ...
        print('best_Iter {}'.format(best_epoch), ':best_Acc2 {:.4f}'.format(best_acc2),'Iter {}'.format(epoch),':Acc {:.4f}'.format(acc),
              ', spe {:.4f}'.format(senspe[1]), ', sen {:.4f}'.format(senspe[0]),', purity {:.4f}'.format(pur),', nmi {:.4f}'.format(nmi),', fscore {:.4f}'.format(f1score),', BACC {:.4f}'.format(Bacc),'total_loss_KL {:.8f}'.format(clustering_loss))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='WM_nxm')
    parser.add_argument('--basis_pretrain_path', type=str, default='data/WM_nxm')
    parser.add_argument('--percentDel', type=int, default=6)
    parser.add_argument('--AE_shuffle', type=bool, default=False)    
    parser.add_argument('--tol', default=1e-7, type=float)
    parser.add_argument('--basis_save_dir', type=str, default='data/WM_nxm')
    acc_ite = np.zeros(5)
    nmi_ite = np.zeros(5)
    ari_ite = np.zeros(5)
    pur_ite = np.zeros(5)
    ...
    foldss = scipy.io.loadmat('data/' + args.dataset + '_percent0.' + str(args.percentDel) + '.mat')
    label = data['Y']  # truth(nX1)
    label = -(label - 1)
