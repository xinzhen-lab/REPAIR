...
%% Example Title
datadir = 'F:\incomplete modle\1_Adaptive Weighted Graph Fusion Incomplete\multi-view-datasets-master\1-complete-data\';
...
for datai = 1:1
    ...
    for per_in = 3:3  % per incomplete ratio 
        in_ratio = per_in*10;
        percent = per30;%percent = cell(1,10);{per_in}
